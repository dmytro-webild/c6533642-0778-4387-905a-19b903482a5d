...
export default function TransfersPage() {
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        { id: "q1", title: "ما هو الحد الأدنى؟", content: "الحد الأدنى هو 10 دولارات." },
        { id: "q2", title: "كم تستغرق التحويلات؟", content: "معظم التحويلات تصل خلال دقائق." },
      ]}
